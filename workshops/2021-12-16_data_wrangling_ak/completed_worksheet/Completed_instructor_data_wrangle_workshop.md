...
- Download the [r markdown file](https://github.com/BCCHR-trainee-omics-group/StudyGroup/blob/master/workshops/2021-12-16_data_wrangling_ak/completed_worksheet/Completed_instructor_data_wrangle_workshop.Rmd) for this workshop and open it in Rstudio.
...
gapminder %>% 
  group_by(continent,year) %>%
  summarize(mean(lifeExp),mean(gdpPercap), mean(pop),median(lifeExp),median(gdpPercap), median(pop))
```
...
## # A tibble: 60 × 8
## # Groups:   continent [5]
##    continent  year `mean(lifeExp)` `mean(gdpPercap)` `mean(pop)` `median(lifeExp…
##    <fct>     <int>           <dbl>             <dbl>       <dbl>            <dbl>
##  1 Africa     1952            39.1             1253.    4570010.             38.8
##  2 Africa     1957            41.3             1385.    5093033.             40.6
##  3 Africa     1962            43.3             1598.    5702247.             42.6
##  4 Africa     1967            45.3             2050.    6447875.             44.7
##  5 Africa     1972            47.5             2340.    7305376.             47.0
##  6 Africa     1977            49.6             2586.    8328097.             49.3
##  7 Africa     1982            51.6             2482.    9602857.             50.8
##  8 Africa     1987            53.3             2283.   11054502.             51.6
##  9 Africa     1992            53.6             2282.   12674645.             52.4
## 10 Africa     1997            53.6             2379.   14304480.             52.8
## # … with 50 more rows, and 2 more variables: median(gdpPercap) <dbl>,
## #   median(pop) <dbl>
```
...
gapminder %>% 
  group_by(continent,year) %>%
  summarize(across(lifeExp:gdpPercap,list(mean=mean,median=median)))
```
...
## # A tibble: 60 × 8
## # Groups:   continent [5]
##    continent  year lifeExp_mean lifeExp_median  pop_mean pop_median
##    <fct>     <int>        <dbl>          <dbl>     <dbl>      <dbl>
##  1 Africa     1952         39.1           38.8  4570010.   2668124.
##  2 Africa     1957         41.3           40.6  5093033.   2885790.
##  3 Africa     1962         43.3           42.6  5702247.   3145210 
##  4 Africa     1967         45.3           44.7  6447875.   3473692.
##  5 Africa     1972         47.5           47.0  7305376.   3945594.
##  6 Africa     1977         49.6           49.3  8328097.   4522666 
##  7 Africa     1982         51.6           50.8  9602857.   5668228.
##  8 Africa     1987         53.3           51.6 11054502.   6635612.
##  9 Africa     1992         53.6           52.4 12674645.   7140388.
## 10 Africa     1997         53.6           52.8 14304480.   7805422.
## # … with 50 more rows, and 2 more variables: gdpPercap_mean <dbl>,
## #   gdpPercap_median <dbl>
```
Alternatively:
...
gapminder %>% 
  group_by(continent,year) %>%
  summarize(across(c(lifeExp,gdpPercap,pop),list(mean=mean,median=median)))
```
...
## # A tibble: 60 × 8
## # Groups:   continent [5]
##    continent  year lifeExp_mean lifeExp_median gdpPercap_mean gdpPercap_median
##    <fct>     <int>        <dbl>          <dbl>          <dbl>            <dbl>
##  1 Africa     1952         39.1           38.8          1253.             987.
##  2 Africa     1957         41.3           40.6          1385.            1024.
##  3 Africa     1962         43.3           42.6          1598.            1134.
##  4 Africa     1967         45.3           44.7          2050.            1210.
##  5 Africa     1972         47.5           47.0          2340.            1443.
##  6 Africa     1977         49.6           49.3          2586.            1400.
##  7 Africa     1982         51.6           50.8          2482.            1324.
##  8 Africa     1987         53.3           51.6          2283.            1220.
##  9 Africa     1992         53.6           52.4          2282.            1162.
## 10 Africa     1997         53.6           52.8          2379.            1180.
## # … with 50 more rows, and 2 more variables: pop_mean <dbl>, pop_median <dbl>
```
...
gapminder %>% 
  group_by(continent,year) %>%
  summarize(across(c(lifeExp,gdpPercap,pop),mean))
```
...
##    <fct>     <int>   <dbl>     <dbl>     <dbl>
##  1 Africa     1952    39.1     1253.  4570010.
##  2 Africa     1957    41.3     1385.  5093033.
##  3 Africa     1962    43.3     1598.  5702247.
##  4 Africa     1967    45.3     2050.  6447875.
##  5 Africa     1972    47.5     2340.  7305376.
##  6 Africa     1977    49.6     2586.  8328097.
##  7 Africa     1982    51.6     2482.  9602857.
##  8 Africa     1987    53.3     2283. 11054502.
##  9 Africa     1992    53.6     2282. 12674645.
## 10 Africa     1997    53.6     2379. 14304480.
## # … with 50 more rows
```
...
gapminder %>% 
  group_by(continent,year) %>%
  mutate(across(c(lifeExp,gdpPercap,pop),round))
```
