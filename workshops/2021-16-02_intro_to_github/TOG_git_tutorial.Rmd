...
**Update 14 January 2021** *Skip the create step for this deliverable; instead use the private repo that was created for you (named `zz_Your-Name_STAT540_2021W2`) - refer back to these instructions in your future work when you'd like to create a new repo.* 
...
I put "Add README.md and the RStudio project file to repository" for mine. All your staged files will be included in this commit. 
